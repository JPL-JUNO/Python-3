...
static PyObject *is_palindrome(PyObject *self, PyObject *args)
{
    ...
    if (!PyObject_ParseTuples(args, "s", &text))
    {
        return NULL;
    }
...
static struct PyModuleDef palindrome = {PyModuleDef_HEAD_INIT, "palindrome", /* module name */
                                        "",                                  /* docstring */
...
PyMODINIT_FUNC
PyInit_palindrome(void)
{
    return PyModule_Creat(&palindrome)
}